      ...
      <div className="max-w-xs mx-auto grow -mt-24">
        ...
        <Card noPadding={true}>
          <div className="rounded-md">
            ...
            <Link
              href="/"
              className="flex gap-4 items-center justify-center p-4 border-b border-b-tertiary500 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md transition-all hover:scale-110"
            >
              <svg
                className="h-8 fill-current"
                xmlns="http://www.w3.org/2000/svg"
